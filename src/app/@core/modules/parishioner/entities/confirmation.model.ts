...
import { ConfirmationGodparentModel } from './confirmation-godparent.model';
import { EntityBase } from '../../../base/entity.base';

export namespace ConfirmationModel {
  ...
  > & {
    ...
    godparents?: ConfirmationGodparentModel.JsonProps[];
  ...
  export class Entity extends EntityBase<Entity> {
    ...
    godparents?: ConfirmationGodparentModel.Entity[];
      ...
      return new Entity({
        ...
        ...(godparents?.length > 0 && {
          godparents: godparents.map((item) => {
            return ConfirmationGodparentModel.Entity.toEntity(item);
          }),
        }),
      });
    }

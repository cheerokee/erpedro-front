...
import { FirstCommunionGodparentModel } from './first-communion-godparent.model';
import { EntityBase } from '../../../base/entity.base';

export namespace FirstCommunionModel {
  ...
  > & {
    ...
    godparents?: FirstCommunionGodparentModel.JsonProps[];
  ...
  export class Entity extends EntityBase<Entity> {
    ...
    godparents?: FirstCommunionGodparentModel.Entity[];
      ...
      return new Entity({
        ...
        ...(godparents?.length > 0 && {
          godparents: godparents.map((item) => {
            return FirstCommunionGodparentModel.Entity.toEntity(item);
          }),
        }),
      });
    }

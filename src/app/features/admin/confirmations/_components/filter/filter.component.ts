...
@Component({
  selector: 'app-filter-confirmations',
...
export class FilterComponent {
  filter = new ConfirmationModel.Filter({});
  form: FormGroup;
  ...
  constructor(
    ...
    this.form.valueChanges.subscribe({
      next: (value: ConfirmationModel.Filter) => {
        this.filter.company_id = value.company_id;
        this.filter.parishioner_id = value.parishioner_id;
        this.filter.confirmation_place = value.confirmation_place;
        this.filter.confirmation_date = value.confirmation_date;

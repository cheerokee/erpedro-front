...
// criação do registro (antes de existir first_communion_id), não só na
// edição.
//
...
// existentes.
export interface FirstCommunionAttachmentRow {
...
@Component({
  selector: 'app-first-communion-attachments-form-list',
  templateUrl: './first-communion-attachments-form-list.component.html',
  styleUrls: ['./first-communion-attachments-form-list.component.scss'],
  imports: [SharedModule, FormsModule, ModalComponent, ModalHeader, ModalBody, ModalFooter],
})
export class FirstCommunionAttachmentsFormListComponent {
  @Input() data: FirstCommunionAttachmentRow[] = [];
  @Output() dataChange = new EventEmitter<FirstCommunionAttachmentRow[]>();
  ...
  constructor(
    private readonly service: FirstCommunionAttachmentService,
  ...
  add() {
    ...
    const row: FirstCommunionAttachmentRow = {
  ...
  download(row: FirstCommunionAttachmentRow) {
